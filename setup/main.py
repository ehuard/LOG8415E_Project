...
if __name__ == "__main__":
    ...
    print(f"Go to http://{info['gatekeeper']['public_dns']}/read to submit a write request,")
    print(f"or to http://{info['gatekeeper']['public_dns']}/write to submit a write request.\n")